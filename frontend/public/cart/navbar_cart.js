const navElements = [
    { title: 'Videojuegos', link: '../../public/categories/catVideojuegos.html' },
    { title: 'Coleccionables', link: '../../public/categories/catColeccionables.html' },
    { title: 'Ropa', link: '../../public/categories/catRopa.html' },
    { title: 'Decoración', link: '../../public/categories/catDecoracion.html' }
];
...
const navBar = `
    <nav class="navbar navbar-expand-lg bg-dark text-light">
        <div class="container-fluid">
            ...
            <a href="../../public/index.html" class="navbar-brand text-light">
