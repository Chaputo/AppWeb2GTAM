        ...
        <div class="container mx-auto flex flex-wrap items-center justify-between">
            ...
            <div id="navbarSupportedContent" class="hidden w-full lg:flex lg:w-auto lg:flex-grow items-center">
                <ul class="flex flex-col lg:flex-row lg:space-x-6 mt-4 lg:mt-0 lg:ml-8 w-full lg:w-auto">
                    ${
                        navElements.map(e => {
                            // Ajustar la ruta si es necesario. Si nav_home.js está en 'categories/', y las categorías están directamente dentro, la ruta es solo 'catVideojuegos.html'
                            // Si categories está en el mismo nivel que la página principal, entonces "../categories/catVideojuegos.html" sería la ruta completa.
                            // Aquí se asume que este nav_home.js es para páginas dentro de 'categories', y por lo tanto, las categorías están en el mismo nivel.
                            return `
                            <li>
...
// Asegurarse de que pageName exista antes de intentar .value
...
window.addEventListener('load', () => {
    ...
    // Asegurarse de que `title` existe antes de intentar manipularlo
    if (title) {
